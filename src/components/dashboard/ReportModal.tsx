...
export function ReportModal({ report, open, onOpenChange }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl rounded-2xl bg-gradient-to-br from-cyan-100/90 via-blue-100/85 to-purple-100/85">
        <DialogHeader>
        ...
        <div className="grid gap-4 md:grid-cols-2 bg-gradient-to-br from-cyan-100/70 via-blue-100/70 to-purple-100/70">

          {/* LEFT */}
          <div className="space-y-3 p-4 rounded-xl bg-white/40">
            <h4 className="font-semibold">Analyzed Text</h4>

            <p className="text-sm leading-6 p-4 rounded-xl bg-muted/50 max-h-[250px] overflow-y-auto">
              {report.content}
            </p>
          ...
          {/* RIGHT */}
          <div className="space-y-4 p-4 rounded-xl bg-white/40">
